...
Stack: static HTML, CSS, and JavaScript, with no build dependency or external data service. Planning by GPT-6 Astra; implementation delegated to GPT-5.6 Sol with low reasoning at the user's request.
